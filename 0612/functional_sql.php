...
/*new*/
function update_selfValuation($order_id, $valuation_id, $valuation_date, $valuation_time){
	$sql_query = "UPDATE `choose` SET ";
	$sql_query .= "valuation_time = '".$valuation_date."' ";
	$sql_query .= "valuation_time = '".$valuation_time."' ";
	$sql_query .= "WHERE valuation_id = ".$valuation_id.";";
	$result = query($sql_query);
	if(!strcmp($result, "1"))
